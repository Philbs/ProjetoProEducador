      ...
      >
        ...
        <div className="p-6 border-t border-gray-800 flex justify-end gap-3 bg-gray-900/50 rounded-b-2xl">
          ...
          <button
            ...
            form="task-form"
            disabled={loading}
            className="px-5 py-2.5 rounded-xl text-sm font-medium text-white bg-[var(--color-neon)] hover:bg-purple-500 transition-colors shadow-lg shadow-purple-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
